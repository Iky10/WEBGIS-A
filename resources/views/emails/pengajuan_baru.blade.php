...
<body>
    <div class="container">
        <div class="header">
            <h1>📋 Pengajuan Baru Masuk</h1>
            <p>{{ $pengajuan->kode_pengajuan }}</p>
        </div>
        <div class="body">
            <p>Ada pengajuan penggunaan gedung baru yang memerlukan persetujuan Anda.</p>
            ...
            <a href="{{ route('pengajuan_gedungs.show', $pengajuan->id) }}" class="btn">
