...
<body>
    ...
    <div id="topbar">
        ...
        <div class="t-search">
            ...
            <input id="searchIn" type="text" class="t-search-in" placeholder="Cari gedung atau alamat…"
                autocomplete="off">
    ...
    <div id="legend">
        ...
        <div class="leg-row">
            <div class="leg-dot" style="background:#22c55e;box-shadow:0 0 5px #22c55e;"></div>Baik
        </div>
        <div class="leg-row">
            <div class="leg-dot" style="background:#f59e0b;box-shadow:0 0 5px #f59e0b;"></div>Sedang
        </div>
        <div class="leg-row">
            <div class="leg-dot" style="background:#ef4444;box-shadow:0 0 5px #ef4444;"></div>Rusak
        </div>
        <div class="leg-row">
            <div class="leg-dot" style="background:#475569;"></div>Tidak diketahui
        </div>
    </div>
    ...
    <div id="routeInfoPanel"
        style="display:none; position:fixed; bottom:80px; right:16px; z-index:900; background:var(--surface-hi); border:1px solid var(--border-hi); border-radius:var(--radius-md); backdrop-filter:var(--blur); padding:14px; max-width:280px; box-shadow:0 12px 40px rgba(0,0,0,.5);">
        <div
            style="font-size:0.78rem; font-weight:800; color:var(--text); margin-bottom:8px; text-transform:uppercase; letter-spacing:.5px;">
            Informasi Rute</div>

        <div style="margin-bottom:12px;">
            <div style="font-size:0.7rem; color:var(--muted); font-weight:600; margin-bottom:3px;">Durasi Perjalanan
            </div>
        ...
        <div style="margin-bottom:12px;">
            <div style="font-size:0.7rem; color:var(--muted); font-weight:600; margin-bottom:3px;">Moda Transportasi
            </div>
        ...
        <div style="border-top:1px solid var(--border); padding-top:10px; display:flex; gap:5px; flex-wrap:wrap;">
            <button class="route-mode-btn active" data-mode="car" onclick="changeRouteMode('car')"
                style="flex:1; min-width:60px; padding:6px; border-radius:6px; background:var(--accent); color:#fff; border:none; font-size:0.7rem; font-weight:700; cursor:pointer; font-family:'Plus Jakarta Sans',sans-serif; transition:all .2s;">🚗
                Mobil</button>
            <button class="route-mode-btn" data-mode="bike" onclick="changeRouteMode('bike')"
                style="flex:1; min-width:60px; padding:6px; border-radius:6px; background:rgba(255,255,255,.05); color:var(--muted); border:1px solid var(--border); font-size:0.7rem; font-weight:700; cursor:pointer; font-family:'Plus Jakarta Sans',sans-serif; transition:all .2s;">🏍️
                Motor</button>
            <button class="route-mode-btn" data-mode="foot" onclick="changeRouteMode('foot')"
                style="flex:1; min-width:60px; padding:6px; border-radius:6px; background:rgba(255,255,255,.05); color:var(--muted); border:1px solid var(--border); font-size:0.7rem; font-weight:700; cursor:pointer; font-family:'Plus Jakarta Sans',sans-serif; transition:all .2s;">🚶
                Jalan</button>
        </div>
    </div>
        ...
        <div class="sb-body">
            ...
            <div id="sbContent" style="display:none;">
                ...
                <div class="sb-info">
                    ...
                    <div class="sb-addr"><i class="fas fa-map-marker-alt"></i> <span id="sbAddr">Alamat Gedung</span>
                    </div>

                    <div class="sb-stats">
                        <div class="sb-stat"><span id="sbFungsi" class="sb-stat-v">-</span><span
                                class="sb-stat-k">Fungsi</span></div>
                        <div class="sb-stat"><span id="sbKondisi" class="sb-stat-v">-</span><span
                                class="sb-stat-k">Kondisi</span></div>
                        <div class="sb-stat"><span id="sbLantai" class="sb-stat-v">-</span><span
                                class="sb-stat-k">Lantai</span></div>
                        <div class="sb-stat"><span id="sbTahun" class="sb-stat-v">-</span><span
                                class="sb-stat-k">Tahun</span></div>
                    </div>
                    ...
                    <div class="sb-section">
                        ...
                        <div id="sbFasilitas" class="sb-sec-text">Informasi fasilitas & kelas pada gedung ini belum
                            tersedia saat ini.</div>
                    </div>

                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-bottom:8px;">
                        <button id="sbBtnRoute" class="sb-cta-btn"
                            style="background:var(--success); box-shadow:0 6px 20px rgba(34,197,94,.35);"><i
                                class="fas fa-directions"></i> Rute ke Sini</button>
                        <button id="sbBtnPhotos" class="sb-cta-btn"><i class="fas fa-images"></i> Lihat Foto</button>
                    </div>
                    <a id="sbBtnPengajuan" href="#" class="sb-cta-btn"
                        style="display:flex; align-items:center; justify-content:center; gap:6px; width:100%; margin-bottom:16px; background:var(--accent); box-shadow:0 6px 20px rgba(59,130,246,.35); text-decoration:none; color:#fff; padding:10px; border-radius:10px; font-size:0.82rem; font-weight:700;">
