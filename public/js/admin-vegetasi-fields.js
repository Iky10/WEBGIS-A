/**
 * admin-vegetasi-fields.js
 * Logic for map picker and photo preview in Vegetasi Create/Edit forms.
 */

document.addEventListener('DOMContentLoaded', function() {
    // ── Elements ───────────────────────────────────────────
    const inputLat = document.getElementById('input_lat_vegetasi');
    const inputLng = document.getElementById('input_lng_vegetasi');
    const fotoUtama = document.getElementById('foto_utama');

    // ── Peta Koordinat Picker ──────────────────────────────
    const mapContainer = document.getElementById('map-picker-vegetasi');
    ...
    const map = L.map('map-picker-vegetasi').setView([defaultLat, defaultLng], initialZoom);
